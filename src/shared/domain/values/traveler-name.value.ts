...
export class TravelerName {
  ...
  public static create(firstName: string, lastName: string): TravelerName {
    firstName = (firstName ?? "").trim();
    lastName = (lastName ?? "").trim();
    return new TravelerName(firstName, lastName);
  }

  public static createv2(firstName: string, lastName: string): Result<AppNotification, TravelerName> {
    ...
    return Result.ok(new TravelerName(firstName, lastName));
  }
}